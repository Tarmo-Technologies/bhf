...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build the BHF docs site")
...
def render_shell(page: Page, content: str, base_url: str) -> str:
    ...
    title = "BHF Documentation" if page.slug == "index" else f"{page.title} - BHF"
...
<body>
  <header>
    <div class="masthead">
      <div class="brand">BHF Documentation</div>
