...
//! each corpus line carries an inline `EXPECT BHF-NNN` annotation where a finding
...
//! measurable claim rather than a marketing line. Seed corpus is bhf-authored
...
/// (line 1-based) -> expected rule id, parsed from `EXPECT BHF-NNN` annotations.
