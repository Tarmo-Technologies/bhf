...
pub const DEFAULT_EVENT_OBSERVER_NAME: &str = "bhf-events";
...
pub mod libafl_engine {
    ...
    pub type BhfInput = BytesInput;
    pub type BhfCorpus = InMemoryCorpus<BhfInput>;
    ...
    pub type BhfState = StdState<BhfCorpus, BhfInput, StdRand, BhfCorpus>;
    pub type BhfEventObserver = ExplicitTracking<StdMapObserver<'static, u8, false>, true, false>;
    ...
    pub type BhfScheduler =
        IndexesLenTimeMinimizerScheduler<QueueScheduler, BhfInput, BhfEventObserver>;

    pub fn new_event_observer(config: &LibAflEngineConfig) -> BhfEventObserver {
    ...
    pub fn new_scheduler(observer: &BhfEventObserver) -> BhfScheduler {
    ...
    pub fn observer_set_bits(observer: &BhfEventObserver) -> usize {
        observer
            .as_ref()
            .iter()
    ...
    pub fn new_state(seed: u64) -> Result<BhfState, libafl::Error> {
