...
impl EngineFeedbackReason {
    ...
    pub fn describe(self) -> &'static str {
        match self {
            Self::None => "bhf:none",
            Self::ExceptionSignature => "bhf:exception-signature",
            Self::BitmapNovelty => "bhf:bitmap-novelty",
            Self::ExceptionSignatureAndBitmap => "bhf:exception-signature+bitmap",
        }
    }
}
...
mod tests {
    ...
    fn exception_signature_feedback_maps_to_afl_and_libafl_objective() {
        ...
        assert_eq!(translated.afl.describe, "bhf:exception-signature");
