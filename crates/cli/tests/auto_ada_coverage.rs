...
//! writes the BHF_COV_SHM edge bitmap), and bounds corpus persistence.
//!
//! This drives the real `bhf auto` against a small Ada fixture and asserts:
