...
//! bhf now (1) supplies an MFC stub defining CString + the window classes
...
fn mfc_cstring_param_builds_and_fuzzes() {
    ...
    assert!(
        main_cpp.contains("CString cmd(_tmp_cmd") && main_cpp.contains("bhf_c_string"),
