...
const SEEDED_METRICS_SCHEMA_VERSION: &str = "bhf.seeded_benchmark.metrics.v1";
const PATTERN_COVERAGE_SCHEMA_VERSION: &str = "bhf.legacy_patterns.coverage.v1";
...
fn scan_static_findings(root: &Path) -> Result<Vec<ObservedFinding>> {
    let report = static_analysis::scan(&static_analysis::StaticScanOptions {
        ...
        out_dir: root.join(".bhf-benchmark-unused"),
