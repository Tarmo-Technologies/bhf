...
//! finding. When they coincide — bhf observed an input actually reach the
...
//! verdict, and records which runtime finding(s) confirmed it. This is bhf's
...
mod tests {
    ...
    fn tmp(tag: &str) -> PathBuf {
        let p = std::env::temp_dir().join(format!("bhf-confirm-{tag}-{}", std::process::id()));
    ...
    fn covered_line_is_marked_fuzz_exercised_uncovered_stays_static() {
        ...
        write_finding(
            ...
            "F-STATIC-0000",
            json!({
                "id": "F-STATIC-0000", "rule_id": "BHF-422", "confirmation": "static",
        ...
        write_finding(
            ...
            "F-STATIC-0001",
            json!({
                "id": "F-STATIC-0001", "rule_id": "BHF-422", "confirmation": "static",
                "classification": "static_scan", "report_only": true,
