...
//!     (`Bhf_Ext_Stub_N`), so the compiler names the exact slot on a mismatch.
...
const PLACEHOLDER_PREFIX: &str = "Bhf_Ext_Stub_";
...
/// The position encoded in a synthetic positional-formal name (`Bhf_Formal_3` -> 2).
...
const SYNTHETIC_FORMAL_PREFIX: &str = "Bhf_Formal_";
...
impl ExternalStubModel {
    ...
    pub fn refine_from_build_output(&mut self, stderr: &str) -> bool {
        ...
        //     derived type: `operator "NOT" not defined for type "Bhf_Ext_Stub_13"`.
        ...
        //       right operand has type "Bhf_Ext_Stub_1" defined at vendorx-doc.ads:4
...
fn render_op_body(
    ...
    match function_result(ret, generic, forms) {
        ...
        FunctionResult::UninitializedLocal => {
            ...
            out.push_str(&format!(
                "{indent}   Bhf_Result : {ret};\n{indent}begin\n{indent}   return Bhf_Result;\n{indent}end {};\n",
                op.name
            ));
        }
...
///   `parser.adb:5:31: error: expected type "Bhf_Stub" defined at vendorlib.ads:2`
...
mod tests {
    ...
    fn seeds_a_function_call_with_arity_and_converges_via_gnat_oracle() {
        ...
        assert!(spec0.contains("P1 : Bhf_Ext_Stub_0"), "{spec0}");
        assert!(spec0.contains("return Bhf_Ext_Stub_1"), "{spec0}");

        // Refine param: GNAT says the arg it FOUND is a String where it expected
        // the placeholder -> param 0 is String.
        let round1 =
            "parser.adb:5:31: error: expected type \"Bhf_Ext_Stub_0\" defined at vendorlib.ads:1\n\
                      parser.adb:5:31: error: found type \"Standard.String\"\n";
        ...
        assert!(
            spec1.contains("return Bhf_Ext_Stub_1"),
        ...
        let round2 = "parser.adb:5:23: error: expected type \"Standard.Integer\"\n\
                      parser.adb:5:23: error: found type \"Bhf_Ext_Stub_1\" defined at vendorlib.ads:1\n";
        ...
        let ph = spec
            ...
            .and_then(|rest| {
                rest.split_whitespace()
                    .find(|w| w.starts_with("Bhf_Ext_Stub_"))
            })
    ...
    fn a_formal_typed_result_with_no_formal_object_uses_an_uninitialized_local() {
        ...
        assert!(
            body.contains("Bhf_Result : Element;") && body.contains("return Bhf_Result;"),
    ...
    fn an_actual_naming_an_entity_of_the_stubbed_library_is_declared_there() {
        ...
        assert!(
            spec.contains("Convert : Bhf_Ext_Stub_"),
    ...
    fn a_logical_operator_resolves_a_placeholder_to_boolean() {
        ...
        let mut model = ExternalStubModel::default();
        model.seed_from_sources(&[src.to_owned()], &pkgset(&["Vendorx.Doc"]));
        let out = "client.adb:5:10: error: operator \"NOT\" not defined for type \"Bhf_Ext_Stub_1\" defined at vendorx-doc.ads:7\n";
        assert!(model.refine_from_build_output(out));
        let spec = model.render_spec("Vendorx.Doc", &model.packages["Vendorx.Doc"]);
        assert!(
    ...
    fn an_operand_type_mismatch_resolves_a_placeholder() {
        ...
        let out = "client.adb:5:25: error: invalid operand types for operator \"+\"\n\
                   ...
                   client.adb:5:25: error: right operand has type \"Bhf_Ext_Stub_1\" defined at vendorx-doc.ads:4\n";
        assert!(model.refine_from_build_output(out));
        let spec = model.render_spec("Vendorx.Doc", &model.packages["Vendorx.Doc"]);
        assert!(
    ...
    fn a_client_child_units_unqualified_names_are_declared_in_the_stubbed_parent() {
        ...
        assert!(
            spec.contains("function No_Parsed_Arguments return Bhf_Ext_Stub_"),
        ...
        let round = "gnatcoll-opt_parse-extension.ads:6:44: error: expected type \"Parsed_Arguments\" defined at gnatcoll-opt_parse.ads:5\n\
                     gnatcoll-opt_parse-extension.ads:6:44: error: found type \"Bhf_Ext_Stub_0\"\n";
        assert!(model.refine_from_build_output(round));
        let spec = model.render_spec("GNATCOLL.Opt_Parse", &model.packages["GNATCOLL.Opt_Parse"]);
        assert!(
    ...
    fn parse_type_note_extracts_quoted_spelling() {
        let line = "parser.adb:5:31: error: expected type \"Bhf_Ext_Stub_0\" defined at x.ads:1";
        assert_eq!(
    ...
    fn string_literal_resolves_a_placeholder_slot_to_string() {
        ...
        model.seed_from_sources(&[src.to_owned()], &pkgset(&["Vendorlib"]));
        let out =
            "parser.adb:5:19: error: expected type \"Bhf_Ext_Stub_0\" defined at vendorlib.ads:1\n\
                   parser.adb:5:19: error: found a string type\n";
        assert!(model.refine_from_build_output(out));
        let spec = model.render_spec("Vendorlib", &model.packages["Vendorlib"]);
        assert!(spec.contains("P1 : String"), "{spec}");
        assert!(!spec.contains("Bhf_Ext_Stub_"), "{spec}");
    }
