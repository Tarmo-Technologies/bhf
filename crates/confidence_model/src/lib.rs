...
pub const CALIBRATION_ID: &str = "bhf.calibrated.v1";
pub const MODEL_SCHEMA_VERSION: &str = "bhf.confidence_model.v1";
pub const LEARNED_MODEL_ID_PREFIX: &str = "bhf.learned.v1";
...
mod tests {
    ...
    fn model_validation_rejects_tampered_model_id() {
        ...
        model.model_id = "bhf.learned.v1.tampered".to_owned();
    ...
    fn model_load_rejects_incompatible_feature_layout() {
        ...
        value["model_id"] = json!("bhf.learned.v1.tampered");
