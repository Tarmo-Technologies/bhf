...
//!
//! Turns bhf's evidence ladder + fuzz-confirmed reachability into a
...
mod tests {
    ...
    fn render_openvex_document_shape() {
        ...
        let doc = render_openvex("bhf:vex:test", "1970-01-01T00:00:00Z", vec![stmt]);
        assert_eq!(doc["@context"], "https://openvex.dev/ns/v0.2.0");
        assert_eq!(doc["@id"], "bhf:vex:test");
        assert_eq!(doc["author"], "bhf");
