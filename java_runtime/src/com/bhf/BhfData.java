...
/**
 * A dependency-free byte→typed-value cursor for bhf-generated Java harnesses —
 * the JVM analog of {@code rust_runtime::Cursor} / {@code c_runtime/bhf_decode.h}
 ...
 */
public final class BhfData {
    private final byte[] data;
    private int pos;

    public BhfData(byte[] data) {
