...
/**
 * bhf's OWN JVM bytecode coverage agent — the native, Jazzer-free equivalent
 ...
 * shared coverage map (see {@link Coverage}). The bhf builtin engine reads
 ...
 *
 * <p>Which classes get instrumented is controlled by {@code BHF_COV_INCLUDE}
...
public final class CoverageAgent {
    ...
    private static boolean shouldInstrument(String internalName) {
        ...
        if (internalName.startsWith("com/bhf/")
    ...
    private static InsnList probe(int blockId) {
        ...
        l.add(new MethodInsnNode(INVOKESTATIC, "com/bhf/Coverage", "recordEdge", "(I)V", false));
        return l;
    }
    ...
    private static void instrumentComparisons(InsnList insns) {
        ...
        for (MethodInsnNode call : calls) {
            ...
            probe.add(new MethodInsnNode(INVOKESTATIC, "com/bhf/Cmplog", hook, desc, false));
    ...
    private static void instrumentSinks(InsnList insns) {
        ...
        for (MethodInsnNode call : calls) {
            ...
            probe.add(new MethodInsnNode(INVOKESTATIC, "com/bhf/Sink", "record", "(I)V", false));
            insns.insertBefore(call, probe);
        }
    }
