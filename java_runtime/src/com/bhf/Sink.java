...
/**
 * bhf's JVM sink-reachability recorder — the native, Jazzer-free equivalent of a
 ...
 * named by {@code BHF_SINK_OUT} at exit, and bhf turns each into a finding
...
public final class Sink {
    ...
    /**
     * Write the reached sink kinds (one integer per line) to {@code BHF_SINK_OUT},
    ...
    public static void report() {
        String path = System.getenv("BHF_SINK_OUT");
        ...
        // fuller campaign report; bhf dedupes kinds on read.
