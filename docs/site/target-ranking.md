...
`bhf auto` can discover far more candidate functions than a time-boxed
...
mean that BHF has predicted the function is vulnerable.
...
Function names contain weak but useful semantic evidence. BHF lowercases
...
Implementation: [`name_semantics.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/name_semantics.rs).
...
Implementation: [`c_rank.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/c_rank.rs).

### C/C++ call-graph adjustment

Signature evidence cannot always distinguish a public parser from the narrow
operations below it. BHF therefore constructs an approximate in-tree call
...
Implementation: [`discovery.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/cli/src/auto/discovery.rs).
...
Implementation: [`score.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/score.rs) and [`heuristics.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/heuristics.rs).
...
Implementation: [`rust_rank.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/rust_rank.rs).
...
Implementation: [`java_rank.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/java_rank.rs).
...
Implementation: [`go_rank.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/go_rank.rs).
...
Implementations: [`python_rank.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/python_rank.rs) and [`perl_rank.rs`](https://github.com/Tarmo-Technologies/bhf/blob/main/crates/target_rank/src/perl_rank.rs).
...
```sh
bhf auto path/to/src --list-targets
```

Use `--languages` to narrow the list without changing the cached discovery:

```sh
bhf auto path/to/src --languages c,cpp --list-targets
```
...
cargo test -p bhf callgraph_ranks_orchestrator_entrypoint_above_leaf_helpers
```
