...
BHF passed 12 of 13 destructive legacy-project scenarios: **92.3%**
...
python3 scripts/validation/legacy-breakage-matrix.py \
  ...
  --offline \
  --workspace /tmp/bhf-legacy-breakage-final-2026-07-19 \
  --jobs 3 \
  --json-out /tmp/bhf-legacy-breakage-final-2026-07-19/summary.json \
  --markdown-out /tmp/bhf-legacy-breakage-final-2026-07-19/summary.md
```
