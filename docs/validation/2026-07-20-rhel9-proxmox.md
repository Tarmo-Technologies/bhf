...
- VM: `108` (`bhf-rhel9-test`), 4 vCPU, 3 GiB maximum / 2 GiB
...
```text
/tmp/bhf-ubuntu-build: /lib64/libc.so.6: version `GLIBC_2.39' not found
```
...
5. The installed binary fuzzed the real miniz fixture: one ranked target built
   ...
   dependencies.
6. The guest-built `bhf`, `bhf-daemon`, and runtrace shim all loaded on
...
```text
/home/bhf/bhf-install/
/home/bhf/bhf-smoke/auto/run.json
/home/bhf/miniz-smoke/auto/run.json
/home/bhf/rhel-dist/
```
