...
Campaign workspace: `/tmp/bhf-legacy-campaign-2026-07-19`

This campaign tested BHF against 37 real GitHub repositories. Repositories
were cloned while online; every BHF run after cloning used only the local
