...
- glibc: 2.17
- SELinux: enforcing
- Compiler used by BHF: Red Hat Developer Toolset
...
2. The release ABI gate reported maximum required versions of `GLIBC_2.16` for
   `bhf` and `bhf-daemon`, and `GLIBC_2.14` for the runtrace shim. All
...
4. The stock CentOS 7 Clang 3.4 was tested with every supported sanitizer
   coverage spelling and correctly rejected because it provides none. BHF
...
```text
bhf-dist-rhel7-final-20260721.tar.gz
...
```text
/home/bhf/bhf-install-el7-final/
/home/bhf/bhf-smoke-final/
/home/bhf/capsule-el7-final-work/
/home/bhf/bhf-install-el7/
/home/bhf/bhf-smoke/
/home/bhf/cpp-smoke/
/home/bhf/miniz-smoke/
```
