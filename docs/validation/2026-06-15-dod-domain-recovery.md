...
Offline validation of `bhf auto` against a spread of public codebases that
...
`bhf list-targets` was run across each full tree to exercise the Ada/C/C++
...
configured, `bhf` discovered ~19.5k targets with zero parser panics,
