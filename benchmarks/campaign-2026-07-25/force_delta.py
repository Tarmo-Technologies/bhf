...
`--force` drives a parameter bhf could not construct — an opaque handle, a
...
gain, but a harness whose parameters are fabricated may exercise only bhf's
own stubs and never the project's code. bhf records that case separately
