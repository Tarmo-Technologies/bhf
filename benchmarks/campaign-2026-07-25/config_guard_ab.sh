...
#
#   BEFORE=/home/ubuntu/bhf-sweep-bin/bhf-force3 \
#   AFTER=/home/ubuntu/bhf-sweep-bin/bhf-0.2.21 sh config_guard_ab.sh
#
...
BEFORE="${BEFORE:-/home/ubuntu/bhf-sweep-bin/bhf-force3}"
AFTER="${AFTER:-/home/ubuntu/bhf-sweep-bin/bhf-0.2.21}"
OUT="${OUT:-/tmp/config-guard-ab}"
CORPUS=/home/ubuntu/bhf-corpus-500/c
