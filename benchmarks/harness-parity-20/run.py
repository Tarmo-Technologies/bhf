...
def run_one(project: dict[str, str], args, sources: Path, work_root: Path,
    ...
    argv = [str(args.bhf), "auto", str(source), "--work-dir", str(work),
...
def main() -> None:
    ...
    parser.add_argument("--bhf", type=Path, default=HERE.parents[1] / "target/release/bhf")
    parser.add_argument("--output", type=Path, default=Path("/tmp/bhf-harness-parity-20"))
